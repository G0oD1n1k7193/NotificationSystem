...
public class Notification {
	...
	public Notification(final NotificationType type, final String text, final int stayTime) {
		super();
		this.resolution = new ScaledResolution(Minecraft.getMinecraft(), Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight);
	...
	public void draw(final float prevY) {
		...
		if (this.deleteMinX()) {
			Main.getInstance().notificationManager.getNotifications().remove(this);
		}
	}
